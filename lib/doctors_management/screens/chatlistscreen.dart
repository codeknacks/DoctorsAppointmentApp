  ...
  void _fetchPatients() async {
    ...
    if (user != null) {
      ...
      for (var doc in appointmentsSnapshot.docs) {
        ...
        String appointmentId = doc.id; // Get the appointmentId
        ...
        if (patientSnapshot.exists) {
          ...
          // Add profilePicUrl and appointmentId to patientData
          patientData['profile_image'] = profilePicUrl;
          patientData['appointmentId'] = appointmentId; // Store appointmentId
